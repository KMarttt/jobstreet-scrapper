...
async def web_scraper(is_rescraping, link_file_name, portal="my", site="jobstreet", location="", keyword="Data-Analyst", max_pages=2):
    ...
    async with async_playwright() as pw:
        ...
        data_frame.to_csv(
            f"data/{site}_{portal}_{location}_{keyword}_rescraped.csv", 
            index=False,
            quotechar='"', 
            escapechar='\\', 
            encoding='utf-8-sig'
        ...
        if error_number > 0:
            ...
            error_frame.to_csv(
                f"data/{site}_{portal}_{location}_{keyword}_rescraped_error.csv", 
                index=False,
                quotechar='"', 
                escapechar='\\', 
                encoding='utf-8-sig'
...
if __name__ == "__main__":
    ...
    if is_rescraping:
        print("Note: The filename format is {site}_{portal}_{location}_{keyword}_rescraped_error.csv")
